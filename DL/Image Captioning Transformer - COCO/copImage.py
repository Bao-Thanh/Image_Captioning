...
def copy_images2(source_folder, destination_folder, num_images):
    os.makedirs(destination_folder, exist_ok=True)
...
copied_files = copy_images2(source_folder, destination_folder, num_images)
print(f"{len(copied_files)} image files have been copied back to the source folder.")
